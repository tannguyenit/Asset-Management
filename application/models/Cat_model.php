...
class Cat_model extends CI_Model {
	...
	public function edit($id_cat)
	{
		...
		$arWhere=array('id_muctaisan'=>$id_cat);
	...
	public function edit_dmcha($id_cat)
	{
		...
		$arWhere=array('id_muctaisancha'=>$id_cat);
		$this->db->where($arWhere);
		$query=$this->db->get();
		return $query->row_array();
	}
	...
	public function get_idcat($id_cat)
	{
		...
		$arWhere=array("muctaisan.id_muctaisancha"=>$id_cat);
		$this->db->where($arWhere);
	...
	public function check_tendm($tendm,$id_dm_cha)
	{
		$this->db->select("*");
		$this->db->from("muctaisan");
		$arWhere=array('tenmuctaisan'=>$tendm,"id_muctaisancha"=>$id_dm_cha);
		$this->db->where($arWhere);
		$query=$this->db->get();
		return $query->row_array();
	}
	public function check_tendm_edit($tendm,$id_cat,$id_dm_cha)
	{
		$this->db->select("*");
		$this->db->from("muctaisan");
		$arWhere=array('tenmuctaisan'=>$tendm,"id_muctaisan!="=>$id_cat,"id_muctaisancha"=>$id_dm_cha);
		$this->db->where($arWhere);
		$query=$this->db->get();
		return $query->row_array();
	}
	public function check_tendmcha($tendm)
	{
		$this->db->select("*");
		$this->db->from("muctaisancha");
		$arWhere=array('tenmuctaisancha'=>$tendm);
		$this->db->where($arWhere);
		$query=$this->db->get();
		return $query->row_array();
	}
	public function check_tendmcha_edit($tendm,$id_cat)
	{
		$this->db->select("*");
		$this->db->from("muctaisancha");
		$arWhere=array('tenmuctaisancha'=>$tendm,"id_muctaisancha!="=>$id_cat);
		$this->db->where($arWhere);
		$query=$this->db->get();
		return $query->row_array();
	}
